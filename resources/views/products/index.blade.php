                                    ...
                                    <div class="top">
                                        <div class="img"><a
                                                    href="{{ route('products.show', ['product' => $product->id]) }}"><img
                                                        src="{{ $product->image_url }}" height="180" alt=""></a></div>
                                        <div class="price"><b>&euro;</b> {{ $product->price }}</div>
                                        <div class="title"><a
...
@section('js')
    <script>
        ...
        function parseSearch() {
            ...
            // substr(1) 将 ? 去除, 然后以符号 & 分割成数组, 然后遍历数组
